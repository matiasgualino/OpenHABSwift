...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func loadSettingsDefaults() {
        ...
        } else if prefs.objectForKey("remoteUrl") == nil {
            prefs.setValue("", forKey: "remoteUrl")
        } else if prefs.objectForKey("username") == nil {
            prefs.setValue("", forKey: "username")
        } else if prefs.objectForKey("password") == nil {
            prefs.setValue("", forKey: "password")
        } else if prefs.objectForKey("ignoreSSL") == nil {
            prefs.setValue("", forKey: "ignoreSSL")
        } else if prefs.objectForKey("demomode") == nil {
            prefs.setValue("", forKey: "demomode")
        } else if prefs.objectForKey("idleOff") == nil {
    ...
    */
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("GLAD", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("GLAD.sqlite")
